...
<head>
    <meta charset="utf-8">
        ...
        <title>{{ config('app.name', 'Tutr') }}</title>

        <meta name="description" content="Tutr">
        <meta name="author" content="TutrCreative">
        <meta name="robots" content="noindex, nofollow">

        <!-- Open Graph Meta -->
        <meta property="og:title" content="Tutr">
        <meta property="og:site_name" content="Tutr">
        <meta property="og:description" content="Tutr">
                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="font-w700" href="/">
                                        <img src="{{ asset('/img/tutr-logo.png') }}" alt="" style="max-width:100%;">
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Crafted with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="http://goo.gl/vNS3I" target="_blank">TutrCreative</a>
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="https://goo.gl/po9Usv" target="_blank">Tutr</a> &copy; <span class="js-year-copy"></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
